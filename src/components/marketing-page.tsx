...
export function MarketingLayout() {
  ...
  return (
    <div
      id="top"
      className="min-h-svh bg-[radial-gradient(circle_at_top,rgba(123,208,255,0.16),transparent_0_24%),linear-gradient(180deg,#0b1326_0%,#08101f_48%,#0b1326_100%)] text-(--marketing-heading)"
    >
          ...
          <div className="relative overflow-hidden rounded-[24px]">
            ...
            <div className="absolute inset-x-0 bottom-0 p-6">
              <div className="max-w-sm rounded-[24px] border border-white/10 bg-[rgba(9,16,31,0.6)] px-5 py-4 backdrop-blur-md">
                <p className="text-xs font-medium tracking-[0.3em] text-(--marketing-sky) uppercase">
      ...
      <section className="mx-auto mt-20 max-w-[1220px] px-4 sm:px-6 lg:px-12">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {processSteps.map((step) => (
            ...
            >
              <p className="text-sm tracking-[0.28em] text-(--marketing-gold) uppercase">
                {step.number}
              </p>
      ...
      <section className="mx-auto grid max-w-[1220px] gap-8 px-4 pt-6 sm:px-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(340px,0.9fr)] lg:items-start lg:px-12">
        ...
        <div className="rounded-[32px] border border-white/8 bg-[linear-gradient(180deg,rgba(19,27,46,0.96),rgba(9,16,31,0.96))] p-6 shadow-[0_24px_70px_rgba(0,0,0,0.32)]">
          <img
            ...
            src="/marketing/mike-profile.jpg"
          />
    ...
    <MarketingPageMain>
      ...
      <section className="mx-auto mt-16 grid max-w-[1220px] gap-6 px-4 sm:px-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)] lg:px-12">
        <article className="overflow-hidden rounded-[34px] border border-white/8 bg-[rgba(19,27,46,0.85)] shadow-[0_26px_70px_rgba(0,0,0,0.3)]">
          ...
          />
          <div className="p-8">
            <p className="text-sm tracking-[0.28em] text-(--marketing-sky) uppercase">
              {featuredPost.category}
            </p>
            <h2 className="mt-3 max-w-2xl font-heading text-4xl tracking-[-0.06em]">
              {featuredPost.title}
            </h2>
            <p className="mt-4 max-w-2xl text-base leading-8 text-(--marketing-copy)">
              {featuredPost.description}
            </p>
            <div className="mt-6 flex items-center justify-between gap-4">
              <p className="text-sm text-(--marketing-copy-soft)">{featuredPost.readTime}</p>
        ...
        <div className="grid gap-6">
          {supportingPosts.map((post) => (
            ...
            >
              ...
              />
              <div>
                <p className="text-xs tracking-[0.28em] text-(--marketing-gold) uppercase">
                  {post.category}
                </p>
                <h3 className="mt-3 font-heading text-2xl tracking-[-0.04em]">{post.title}</h3>
                <p className="mt-2 text-sm leading-7 text-(--marketing-copy)">{post.description}</p>
                <p className="mt-4 text-sm text-(--marketing-copy-soft)">{post.readTime}</p>
              </div>
            </article>
          ))}
      ...
      <section className="mx-auto mt-16 grid max-w-[1220px] gap-8 px-4 sm:px-6 lg:grid-cols-[minmax(320px,0.82fr)_minmax(0,1.18fr)] lg:px-12">
        <div className="flex flex-col gap-8">
          <div className="rounded-[32px] border border-white/8 bg-[rgba(19,27,46,0.85)] p-8 shadow-[0_24px_70px_rgba(0,0,0,0.3)]">
            <h2 className="font-heading text-3xl tracking-[-0.05em]">Contact Details</h2>
          ...
          <div className="overflow-hidden rounded-[32px] border border-white/8 bg-[rgba(19,27,46,0.85)]">
            ...
            <div className="border-t border-white/8 px-6 py-5">
              ...
              <p className="mt-2 text-base text-(--marketing-copy)">Charlevoix, MI</p>
            </div>
          </div>
        </div>
      ...
      <section className="mx-auto mt-16 grid max-w-[1220px] gap-8 px-4 sm:px-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(300px,0.8fr)] lg:px-12">
        ...
        <div className="grid gap-4">
          ...
          <div className="rounded-[28px] border border-white/8 bg-[rgba(19,27,46,0.8)] p-6">
            <p className="text-sm tracking-[0.28em] text-(--marketing-copy-soft) uppercase">Role</p>
      ...
      <div className="mt-16 grid gap-6 lg:grid-cols-3 lg:items-stretch">
        {marketingServices.map((service) => {
          ...
          return (
            ...
            >
              {service.featured ? (
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full border border-[rgba(60,47,0,0.12)] bg-(--marketing-gold) px-6 py-2 text-[11px] font-semibold tracking-[0.22em] text-(--marketing-gold-foreground) uppercase shadow-[0_10px_30px_rgba(0,0,0,0.2)]">
                  Most Popular
                </div>
              ) : null}
              ...
              >
                ...
                <div className="min-w-0 pt-1 text-right">
                  <p className="text-sm tracking-[0.18em] text-(--marketing-sky) uppercase sm:text-base">
                    {service.eyebrow}
                  </p>
                  ...
                  {service.priceDetail ? (
                    <div className="mt-1.5 inline-flex self-end rounded-[14px] px-1 text-right">
                      <div className="flex flex-col items-end gap-0.5">
                        ...
                        <span className="text-[0.82rem] leading-none tracking-[0.01em] whitespace-nowrap text-(--marketing-copy)/82">
    ...
    <section className="mx-auto grid max-w-[1220px] gap-8 px-4 pt-6 sm:px-6 lg:grid-cols-[minmax(0,1.02fr)_minmax(320px,0.98fr)] lg:items-start lg:px-12">
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap gap-3">
          <MarketingButtonLink showIcon={false} to="/contact">
            Start a Project
          </MarketingButtonLink>
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="text-xs tracking-[0.22em] text-(--marketing-sky) uppercase">
                    {service.eyebrow}
                  </p>
    ...
    <section className="mx-auto mt-20 grid max-w-[1220px] gap-8 px-4 sm:px-6 lg:grid-cols-[minmax(320px,0.95fr)_minmax(0,1.05fr)] lg:items-center lg:px-12">
      ...
      <div className="space-y-5">
        ...
        <div className="rounded-[20px] border border-white/8 bg-[rgba(19,27,46,0.82)] px-5 py-4">
          ...
          <p className="mt-1 text-sm text-(--marketing-copy)">45.3181° N, 85.2584° W</p>
        </div>
      </div>
    </section>
  );
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-white/6 bg-[rgba(11,19,38,0.76)] backdrop-blur-xl">
      <div className="mx-auto flex max-w-[1280px] flex-wrap items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-12">
        <Link className="font-heading text-xl tracking-[-0.06em] text-(--marketing-gold)" to="/">
          Mike Cebulski
        </Link>

        <nav className="flex flex-wrap items-center justify-center gap-2 text-sm text-(--marketing-copy)">
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div className="min-w-0">
                              <p className="text-[11px] tracking-[0.2em] text-(--marketing-sky) uppercase">
                                {caseStudy.eyebrow}
                              </p>
                              <p
                                className={cn(
...
function MarketingInlineLink({
  ...
  const className =
    "inline-flex items-center gap-2 text-sm font-semibold text-(--marketing-gold) transition-transform hover:translate-x-1";
...
function MarketingEyebrow({ children }: { readonly children: ReactNode }) {
  return (
    <p className="text-xs font-medium tracking-[0.32em] text-(--marketing-sky) uppercase">
      {children}
    </p>
  );
}
...
function MarketingStatCard({ label, value }: { readonly label: string; readonly value: string }) {
  return (
    <div className="rounded-[20px] border border-white/8 bg-[rgba(19,27,46,0.82)] px-5 py-4">
      <p className="text-xs tracking-[0.28em] text-(--marketing-copy-soft) uppercase">{label}</p>
  ...
  return (
    <div className="flex gap-4">
      ...
      <div>
        ...
        <p className="mt-1 text-base text-(--marketing-copy)">{value}</p>
        {detail ? <p className="text-sm text-(--marketing-copy-soft)">{detail}</p> : null}
      </div>
    </div>
  );
}
...
function PaginationChip({
  ...
  return (
    <div
      className={cn(
        "flex h-10 min-w-10 items-center justify-center rounded-full border border-white/8 px-4 text-sm text-(--marketing-copy)",
        active && "border-(--marketing-gold)/40 bg-white/6 text-(--marketing-gold)",
      )}
    >
      {label}
    </div>
      ...
      <div className="mx-auto grid max-w-[1280px] gap-12 px-4 py-14 sm:px-6 lg:grid-cols-[minmax(0,1.2fr)_220px_220px] lg:px-12">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-3 text-sm text-(--marketing-copy)">
            <Link className="transition-colors hover:text-(--marketing-heading)" to="/services">
              Overview
            </Link>
            <Link
              className="transition-colors hover:text-(--marketing-heading)"
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-3 text-sm text-(--marketing-copy)">
            <Link className="transition-colors hover:text-(--marketing-heading)" to="/">
              Home
            </Link>
            <Link className="transition-colors hover:text-(--marketing-heading)" to="/about">
              About
            </Link>
            <Link className="transition-colors hover:text-(--marketing-heading)" to="/contact">
              Contact
            </Link>
          </div>
        </div>
